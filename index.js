...
const serialCamera =  new serCam(process.env.SERIALIZATION_CAM_IP,process.env.SERIALIZATION_CAM_PORT,serQueue);
serialCamera.connect()

const printer = new TIJPrinter(process.env.TiJPrinter_IP, process.env.TiJPrinter_PORT,process.env.SERIALIZATION_CAM_IP,"1")
printer.connect()
