...
const printerTemplate = {
    ...
    template2: function (details, fileName) {
        ...
        const ED = printer.createModuleText(`ED  ${details.ED}`,  true,  10,  206,  0,  22,  0,  "Arial");
        const HET = printer.createModuleText(`HET ${details.HET}`,  true,  10,  234,  0,  22,  0,  "Arial");
        const field = printer.createModuleField(10, 264, 0, 22, -5, "Arial", 15, 0, 1, 0, 0); // SN
